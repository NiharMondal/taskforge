...
export default function IssueDetailModal({
  ...
  return (
    <Modal isOpen={!!issue} onOpenChange={(open) => !open && onClose()}>
      <Modal.Backdrop>
        <Modal.Container>
          <Modal.Dialog>
            {issue && (
      ...
      <Modal.Body className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onSelectionChange={(key) =>
                key != null && setStatus(String(key) as IssueStatus)
              }
              fullWidth
            >
              <Select.Trigger>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onSelectionChange={(key) =>
                key != null && setPriority(String(key) as IssuePriority)
              }
              fullWidth
            >
              <Select.Trigger>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <Select
            ...
            onSelectionChange={(key) => key != null && setAssigneeId(String(key))}
            fullWidth
          >
            <Select.Trigger>
              <Select.Value />
            ...
            <Select.Popover>
              <ListBox>
                <ListBox.Item key={UNASSIGNED} id={UNASSIGNED} textValue="Unassigned">
                  Unassigned
                </ListBox.Item>
                {members.map((m) => (
                  <ListBox.Item
